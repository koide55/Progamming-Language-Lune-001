...
You get three things: what it means, a minimal example that triggers it, and how to fix it. Add `--lang ja` to read it **in Japanese** (in the REPL: `:explain TYP0001 ja`). To browse the full catalog of every code, open `documents/ERROR_INDEX.md` (Japanese version: `ERROR_INDEX_JA.md`).
